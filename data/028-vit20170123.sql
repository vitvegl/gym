...
insert into `workout` (`workout_date`, `workout_duration`, `athlet_id`)
  values
('2017-01-23', null, (select @athlet_id));

call set_workout_id ('vit', '2017-01-23');
...
('Махи у сторони', 7, 10, 90, (select @workout_id)),
('Махи у сторони', 7, 8, 90, (select @workout_id)),
('Махи у сторони', 7, 10, 90, (select @workout_id)),
('Махи у сторони', 7, 10, 90, (select @workout_id)),
('Тяга 1 рукою у нахилі', 23, 13, 120, (select @workout_id)),
('Тяга 1 рукою у нахилі', 23, 13, 120, (select @workout_id)),
('Тяга 1 рукою у нахилі', 23, 13, 120, (select @workout_id)),
('Жим сидячи', 13, 12, 120, (select @workout_id)),
('Жим сидячи', 13, 12, 120, (select @workout_id)),
...
where a.nickname = 'vit' and w.workout_date = '2017-01-23';
