...
insert into `workout` (`workout_date`, `workout_duration`, `athlet_id`)
  values
('2017-02-04', '1:00', (select @athlet_id));

call set_workout_id ('vit', '2017-02-04');
...
('Присідання', 30, 13, 120, (select @workout_id)),
('Присідання', 30, 13, 120, (select @workout_id)),
('Концентрований підйом на біцепс', 9, 13, 120, (select @workout_id)),
...
where a.nickname = 'vit' and w.workout_date = '2017-02-04';
