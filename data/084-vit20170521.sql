...
insert into `workout` (`workout_date`, `start_time`, `finish_time`, `athlet_id`)
  values
('20170521', '13:40', '15:21', (select @athlet_id));
...
('Жим лежачи', 50, 6, 60, (select @workout_id)),
('Махи вперед', 6, 10, 60, (select @workout_id)),
('Махи вперед', 6, 10, 60, (select @workout_id)),
('Махи вперед', 6, 10, 60, (select @workout_id)),
('Махи у сторони', 6, 10, 60, (select @workout_id)),
('Махи у сторони', 6, 10, 60, (select @workout_id)),
('Махи у сторони', 6, 10, 60, (select @workout_id)),
('Тяга у нахилі', 50, 10, 90, (select @workout_id)),
('Тяга у нахилі', 50, 10, 90, (select @workout_id)),
('Тяга у нахилі', 50, 10, 90, (select @workout_id)),
('Жим стоячи із-за голови', 30, 10, 90, (select @workout_id)),
('Жим стоячи із-за голови', 30, 8, 90, (select @workout_id)),
('Жим стоячи із-за голови', 30, 8, 90, (select @workout_id)),
('Станова тяга', 50, 16, 60, (select @workout_id)),
('Станова тяга', 50, 17, 0, (select @workout_id));
