...
('Станова тяга', 30, 9, 120, 3, (select @workout_id)),
...
('Згинання рук стоячи', 8.2, 7, 120, 2, (select @workout_id)),
...
('Махи вперед', 5, 10, 120, 4, (select @workout_id)),
('Хаммер', 8.2, 10, 120, 1, (select @workout_id)),
('Хаммер', 8.2, 7, 120, 2, (select @workout_id)),
('Хаммер', 8.2, 7, 0, 3, (select @workout_id));
...
call calculate_tonnage ('vit', '2016-11-25');
