...
insert into `workout` (`workout_date`, `workout_duration`, `athlet_id`)
  values
('2017-01-03', '0:58', (select @athlet_id));

call set_workout_id ('vit', '2017-01-03');
...
insert into `exercise` (`description`, `weight_kg`, `reps`, `rest_time_sec`, `workout_id`)
  values
('Станова тяга', 33, 10, 180, (select @workout_id)),
('Станова тяга', 33, 10, 180, (select @workout_id)),
('Станова тяга', 33, 10, 180, (select @workout_id)),
...
where a.nickname = 'vit' and w.workout_date = '2017-01-03';
