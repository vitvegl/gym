...
insert into `workout` (`workout_date`, `workout_duration`, `athlet_id`)
  values
('20170326', '00:30', (select @athlet_id));

call set_workout_id ('vit', '20170326');
