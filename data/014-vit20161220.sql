...
insert into `exercise` (`description`, `weight_kg`, `reps`, `rest_time_sec`, `workout_id`)
  values
('Жим лежачи', 22.2, 9, 120, (select @workout_id)),
('Жим лежачи', 22.2, 8, 120, (select @workout_id)),
('Жим лежачи', 22.2, 4, 120, (select @workout_id)),
...
('Пулл-овер стоячи', 13, 7, 120, (select @workout_id)),
('Розведення рук лежачи', 13, 10, 120, (select @workout_id)),
('Розведення рук лежачи', 13, 10, 120, (select @workout_id)),
('Розведення рук лежачи', 13, 10, 120, (select @workout_id)),
('Розведення рук лежачи', 13, 9, 120, (select @workout_id)),
('Віджимання від підлоги', 0, 8, 120, (select @workout_id)),
('Віджимання від підлоги', 0, 8, 120, (select @workout_id)),
('Віджимання від підлоги', 0, 7, 120, (select @workout_id)),
('Шраги', 23, 10, 120, (select @workout_id)),
('Шраги', 23, 10, 120, (select @workout_id)),
('Шраги', 23, 10, 120, (select @workout_id)),
('Шраги', 23, 10, 120, (select @workout_id));
