...
call update_exercise_set_equipment ('vit', '2017-02-08', 'гантель', 'Пулл-овер стоячи', 1);
call update_exercise_set_equipment ('vit', '2017-02-08', 'гантель', 'Пулл-овер стоячи', 2);
call update_exercise_set_equipment ('vit', '2017-02-08', 'гантель', 'Пулл-овер стоячи', 3);
call update_exercise_set_equipment ('vit', '2017-02-08', 'гантель', 'Пулл-овер стоячи', 4);
call update_exercise_set_equipment ('vit', '2017-02-08', 'гантель', 'Пулл-овер стоячи', 5);
