...
('Жим лежачи', 25, 7, 120, 3, (select @workout_id)),
...
('Розведення рук лежачи', 13, 17, 90, 2, (select @workout_id)),
('Розведення рук лежачи', 13, 16, 90, 3, (select @workout_id)),
('Шраги', 25, 25, 120, 1, (select @workout_id)),
('Шраги', 25, 20, 120, 2, (select @workout_id)),
('Шраги', 25, 20, 120, 3, (select @workout_id)),
...
/* call update_exercise_set_equipment_specific_set ('vit', '2017-03-03', 'гантель', 'Пулл-овер стоячи', 1); */
/* call update_exercise_set_equipment_specific_set ('vit', '2017-03-03', 'гантель', 'Пулл-овер стоячи', 2); */
/* call update_exercise_set_equipment_specific_set ('vit', '2017-03-03', 'гантель', 'Пулл-овер стоячи', 3); */
call update_exercise_set_equipment ('vit', '2017-03-03', 'гантель', 'Пулл-овер стоячи');

call calculate_tonnage ('vit', '2017-03-03');
