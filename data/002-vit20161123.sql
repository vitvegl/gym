...
('Жим лежачи', 19.5, 11, 120, 3, (select @workout_id)),
('Присідання', 21, 8, 120, 1, (select @workout_id)),
('Присідання', 21, 8, 120, 2, (select @workout_id)),
('Присідання', 21, 8, 120, 3, (select @workout_id)),
...
('Згинання рук стоячи', 8.2, 7, 120, 3, (select @workout_id)),
...
('Махи вперед', 5, 8, 120, 3, (select @workout_id)),
('Хаммер', 9, 8, 120, 1, (select @workout_id)),
('Хаммер', 9, 7, 120, 2, (select @workout_id)),
('Хаммер', 9, 7, 120, 3, (select @workout_id)),
('Віджимання від підлоги', 0, 15, 120, 1, (select @workout_id)),
('Віджимання від підлоги', 0, 11, 120, 2, (select @workout_id)),
('Віджимання від підлоги', 0, 11, 0, 3, (select @workout_id));
...
/* call update_exercise_set_equipment_specific_set ('vit', '2016-11-23', 'гантель', 'Пулл-овер стоячи', 1); */
/* call update_exercise_set_equipment_specific_set ('vit', '2016-11-23', 'гантель', 'Пулл-овер стоячи', 2); */
/* call update_exercise_set_equipment_specific_set ('vit', '2016-11-23', 'гантель', 'Пулл-овер стоячи', 3); */
call update_exercise_set_equipment ('vit', '2016-11-23', 'гантель', 'Пулл-овер стоячи');

call calculate_tonnage ('vit', '2016-11-23');
