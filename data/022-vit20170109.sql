...
insert into `workout` (`workout_date`, `workout_duration`, `athlet_id`)
  values
('2017-01-09', '1:00', (select @athlet_id));

call set_workout_id ('vit', '2017-01-09');
...
('Тяга 1 рукою у нахилі', 23, 10, 120, (select @workout_id)),
('Тяга 1 рукою у нахилі', 23, 10, 120, (select @workout_id)),
('Жим сидячи', 12.2, 12, 120, (select @workout_id)),
('Жим сидячи', 12.2, 12, 120, (select @workout_id)),
...
where a.nickname = 'vit' and w.workout_date = '2017-01-09';
