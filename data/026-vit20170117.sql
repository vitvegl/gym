...
('Жим лежачи', 23, 5, 120, 4, (select @workout_id)),
...
('Розведення рук лежачи', 15, 8, 120, 1, (select @workout_id)),
...
call update_exercise_set_equipment ('vit', '2017-01-17', 'гантель', 'Пулл-овер стоячи');
...
call update_exercise_set_equipment ('vit', '2017-01-17', 'гантель', 'Присідання Пліє');
